...
Most of these come down to network reality or how mathworld serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mathworld rate-limits like any public site. mw already paces
...
Where a surface is gated, mw reads a cookie or token you supply
...
`mw`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mw actually did
